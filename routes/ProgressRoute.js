...
import {getAllProgress, savePartialProgress, updateLastLecture} from "../controllers/progressController.js";
router.route("/progress/:userId/:courseId/").get(getAllProgress);
router.route("/partial/").post(savePartialProgress);
router.route("/progress/lastLecture").put(updateLastLecture);
